...
.config(['$routeProvider', function($routeProvider) {
  ...
  $routeProvider.when('/categories/:category', {templateUrl: 'partials/category_topic.html', controller: 'TopicCtrl'});
  $routeProvider.when('/categories/:category/:topic', {templateUrl: 'partials/category_post.html', controller: 'PostCtrl'});
